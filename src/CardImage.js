export default {
  ...
  <div class="position-relative">
    ...
    <a v-if="!backside && size != 'small'" v-show="!card.flipped" :href="card.scryfall_url" target="_blank" class="scryfall-button" :class="{ 'scryfall-button-battle': card.types.includes('Battle') }">
